    ...
    >
      ...
      {activeView==="home"?(
        ...
        <div style={{padding:"16px 16px 40px",display:"flex",flexDirection:"column",gap:14,...viewTransitionStyle}}>
          ...
          {Capacitor.getPlatform() === "ios" ? (
            <SurfaceCard>
              <div style={{fontSize:11,textTransform:"uppercase",letterSpacing:"0.08em",color:"#7c8aa5",fontWeight:700,marginBottom:10}}>Calendar Sync</div>
              <div
                style={{
                  fontSize:13,
                  fontWeight:700,
                  marginBottom:8,
                  color:stravaConnected ? "#86efac" : "#94a3b8",
                  lineHeight:1.45,
                }}
              >
