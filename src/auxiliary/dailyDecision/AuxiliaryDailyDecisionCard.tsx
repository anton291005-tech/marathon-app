/**
 * AUXILIARY — sandbox / experimental only.
 * Do not mount on primary Home or recovery surfaces; SSOT UI must use RecoveryDomainState presentation.
 */
import type { DailyDecision } from "./ruleEngine";
...
export default function AuxiliaryDailyDecisionCard({ decision }: Props) {
